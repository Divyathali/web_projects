class NYTIME {
  ...
  async getUser(startyear,endyear,article_topic) {
    ...
    const Response = await fetch(`https://api.nytimes.com/svc/search/v2/articlesearch.json?q=${article_topic}&begin_date=${startyear}&end_date=${endyear}&fq=source:("The New York Times")&page=0&sort=oldest&api-key=XIcIoEHd3VYGqLa1wfNimqVDfbZqnsqY`); 
